...
Over 10,000 human coded events from 470 pivotal crises in international relations, in a new dataset International Crises Behavior Events (ICBe). Use this website to visualize the data and compare to pre-existing state of the art event datasets. Read our [introduction to the data paper](https://github.com/CenterForPeaceAndSecurityStudies/ICBEdataset/raw/master/paper/ICBEdataset_paper_rex.pdf) and  [view the underlying Code](https://github.com/CenterForPeaceAndSecurityStudies/ICBEdataset), and [download the data for free](https://github.com/CenterForPeaceAndSecurityStudies/ICBEdataset) for your own work.
