...
Over 10,000 human coded events from 470 pivotal crises in international relations in the new ICBe dataset (International Crises Behavior events). Read our [introduction to the data paper](https://github.com/CenterForPeaceAndSecurityStudies/ICBEdataset) and [download the data for free](https://github.com/CenterForPeaceAndSecurityStudies/ICBEdataset), and visualize the data compared to the pre-existing state of the art below. <a class="twitter-share-button" href="https://twitter.com/intent/tweet?text=Hello%20world">Tweet</a>
