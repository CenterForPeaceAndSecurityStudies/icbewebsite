...
470 pivotal crises in international relations, recorded chess move by chess move in the new ICBe (International Crises Behavior events) dataset ([paper and raw data](https://github.com/CenterForPeaceAndSecurityStudies/ICBEdataset)).

This website visualizes each chess match - pick a decade, year, and crisis to see for yourself.
