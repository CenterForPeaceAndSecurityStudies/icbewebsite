...
library(stringr)
library(svglite)
#icb_crises <-readRDS(paste0(here::here(), "/data/in/icb1v14.Rds") )
icb_crises <-read_csv(paste0(here::here(), "/data/in/icb1v14.csv") )
...
show_plot <- function(x){
  ...
  plot_path <- paste0(here::here(), "/docs/images/",basename(x))
  cat(sep="",
...
map <- function(crisis, fromscratch=T){
  ...
  save_file_p <- paste0(here::here(), "/docs/images/ggplots/p_metro_plot_",crisis,".Rds")
  save_file_png <- paste0(here::here(), "/docs/images/p_metro_plot_",crisis,".svg")

  save_file_ft <- paste0(here::here(),"/docs/images/sentence_tables/ft_sentence_table_",crisis,".Rds") #
  save_file_ft_png <- paste0(here::here(), "/docs/images/ft_sentence_table_",crisis,".png") #

  save_file_mids_p <- paste0(here::here(), "/docs/images/ggplots/p_mids_metro_plot_",crisis,".Rds")
  save_file_mids_png <- paste0(here::here(), "/docs/images/p_mids_metro_plot_",crisis,".svg")

  save_file_icb_p <- paste0(here::here(), "/docs/images/ggplots/p_icb_metro_plot_",crisis,".Rds")
  save_file_icb_png <- paste0(here::here(), "/docs/images/p_icb_metro_plot_",crisis,".svg")
  ...
  if(file.exists(save_file_p)){
    ...
    #Phoenix
    save_file_phoenix_p <- paste0(here::here(), "/docs/docs/images/ggplots/p_phoenix_metro_plot_",crisis,".Rds")
    save_file_phoenix_png <- paste0(here::here(), "/docs/images/p_phoenix_metro_plot_",crisis,".svg")
    ...
    #terrier
    save_file_terrier_p <- paste0(here::here(), "/docs/docs/images/ggplots/p_terrier_metro_plot_",crisis,".Rds")
    save_file_terrier_png <- paste0(here::here(), "/docs/images/p_terrier_metro_plot_",crisis,".svg")
    ...
    #ICEWS
    save_file_icews_p <- paste0(here::here(), "/docs/docs/images/ggplots/p_icews_metro_plot_",crisis,".Rds")
    save_file_icews_png <- paste0(here::here(), "/docs/images/p_icews_metro_plot_",crisis,".svg")
    ...
    #Mids Incidents
    save_file_mids_incidents_p <- paste0(here::here(), "/docs/docs/images/ggplots/p_mids_incidents_metro_plot_",crisis,".Rds")
    save_file_mids_incidents_png <- paste0(here::here(), "/docs/images/p_mids_incidents_metro_plot_",crisis,".svg")
    ...
    #UCDP-GED Incidents
    save_file_ucdp_p <- paste0(here::here(), "/docs/docs/images/ggplots/p_ucdp_metro_plot_",crisis,".Rds")
    save_file_ucdp_png <- paste0(here::here(), "/docs/images/p_ucdp_metro_plot_",crisis,".svg")
